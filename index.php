...
<?php include_once('layouts/header_index.php'); ?>
      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          ...
          <div class="sub-heading">
            ...
            <a class="button_slide slide_down"href="pages/nosotros.php">Saber Mas</a>
          ...
          <div class="team-box">
            ...
            <div class="roles">
              ...
              <ul class="social-profile">
                <li><a href="pages/parvularia_page.php"><i class="fa  fa-lg"> Mas Información</i></a></li>
              </ul>
            </div>
          </div>
        </div>
